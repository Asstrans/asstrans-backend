...
public class RequisicaoMesAssociado {
    ...
    public RequisicaoMesAssociado(Long id_requisicao, Double valor_total, Double valor_parcela, Long id_associado, String nome_associado, Long id_convenio, String nome_convenio) {
