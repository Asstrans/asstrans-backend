...
public class PlanoAssociadoAll {
    ...
    public PlanoAssociadoAll() {}

    public PlanoAssociadoAll(Long id_plano, String razao_social, Double valor_plano, String nome_plano, Long id_associado, String nome_associado) {
